...
window.onload=()=>{
    ...
    const bb=document.getElementsByClassName('bb')[0]
    const cc=document.getElementsByClassName('cc')
    for (let i = 0; i < 200; i++) {
        bb.innerHTML +="<div class='cc'></div>"
    ...
    // let xx=false
    // let lenghtss=document.querySelector(".website").children
    // document.querySelector('.titles').addEventListener('click',()=>{
    //     xx = !xx
    //     if(xx){
    //         document.querySelector('.du').style.transform="rotate(90deg)"
    //         document.querySelector('aside .xx ul').style.height=lenghtss.length*40+"px"
    //     }else{
    //         document.querySelector('.du').style.transform="rotate(0)"
    //         document.querySelector('aside .xx ul').style.height=""
